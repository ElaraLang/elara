...
- *(emit)* :sparkles: Add JVM IR and JVM Emitting - ([26cd24e](https://github.com/ElaraLang/elara/commit/26cd24ed66e98517905caffdc2d4935065eb70a5)) 
...
- *(main)* :lipstick: Introduce proper CLI - ([1f35590](https://github.com/ElaraLang/elara/commit/1f355903199d4c486429285f338d9a1e44af48ff)) 
...
- *(parser)* Allow infix patterns in declarations, eg `let x + y = ...` - ([81dad53](https://github.com/ElaraLang/elara/commit/81dad531db85ba8e6cb581c995569111ac1c99e5)) 
...
- Actually implement closure lifting - ([67bfbb4](https://github.com/ElaraLang/elara/commit/67bfbb4cf46b3dc941434f745e81fbfd07f7bf5c)) 
...
- Support type aliases - ([3befe85](https://github.com/ElaraLang/elara/commit/3befe85496a75250929e02d926cca8abd390e371)) 
...
- *(lexer)* Fix slightly incorrect whitespace handling - ([7d04ef5](https://github.com/ElaraLang/elara/commit/7d04ef53767fb853d1cc958f1fb5b0b7a8e33dd8)) 
...
- *(stdlib)* Fix 'Tuple2' definition in stdlib - ([43908bf](https://github.com/ElaraLang/elara/commit/43908bf4b755ce13c835670c08f59d72b80cc57f)) 
...
- *(tests)* Comments being treated as operators - ([ed24e41](https://github.com/ElaraLang/elara/commit/ed24e415474a9d1446147f16a6951c9b35b389e9)) 
...
- *(type-infer)* Fix `runReachableSubgraphQuery` not handling mutually recursive dependencies properly - ([e2f7b6b](https://github.com/ElaraLang/elara/commit/e2f7b6b717b9026e574ba455035c2b6d539418c2)) 
- *(type-infer)* Fix type aliases with type variables - ([a005d7e](https://github.com/ElaraLang/elara/commit/a005d7e39eb7bd1aad8e7533b4e7c208e0a606b1)) 
...
- *(core)* :mute: Remove debug logging from 'equalUnderSubst' - ([3717627](https://github.com/ElaraLang/elara/commit/371762766c4530346525898b926c67922d3be733)) 
- *(core)* Update debug logging - ([b1939e6](https://github.com/ElaraLang/elara/commit/b1939e6c9557c4f64c052c7823175d7be9ea08e2)) 
- *(core)* :recycle: Fix bugs and improve code structure of Match lowering - ([b7089fa](https://github.com/ElaraLang/elara/commit/b7089fa2ff69c242ffbabd68414e1565172af6c1)) 
...
- *(desugarer)* Remove use of `unsafeCoerce` - ([374d5c8](https://github.com/ElaraLang/elara/commit/374d5c86734a352a224a8aef353cb7641b36cea0)) 
...
- *(lexer)* Improve Lexer error reporting - ([af7ac3f](https://github.com/ElaraLang/elara/commit/af7ac3f95c02468c91c8384862cebf4dd2e0544c)) 
...
- *(parser)* Use new type declaration syntax - ([5ca7c5b](https://github.com/ElaraLang/elara/commit/5ca7c5b4fa342c6b509967cd0af2f3815bfa6208)) 
...
- *(query)* Significantly improve Query system's errors and code - ([7a8f2d1](https://github.com/ElaraLang/elara/commit/7a8f2d1b255c7d09b8ac4495556f1d291bdb382d)) 
...
- *(renamer)* Properly detect recursive type aliases - ([9a491c6](https://github.com/ElaraLang/elara/commit/9a491c6b87b6a43d7f2e4e18b51084c97c3f5a5a)) 
...
- *(type-infer)* :lipstick: Improve presentation of TypeConstructorMismatch error - ([4dda8f5](https://github.com/ElaraLang/elara/commit/4dda8f5b9fa5f0a42b257d08ff90ded8cbfc2cf9)) 
- *(type-infer)* Add query to get a `TypedExpr` by name - ([3e74c25](https://github.com/ElaraLang/elara/commit/3e74c25a62eae728d809ff8ae60a7c3c5a8807e0)) 
...
- Compare Core.Var by name only, ignoring types - ([f582e3f](https://github.com/ElaraLang/elara/commit/f582e3f310810bc569ddf79d93c595c3d6a22fbe)) 
...
- *(examples)* Improve examples - ([7e038db](https://github.com/ElaraLang/elara/commit/7e038db337055eae330fedcc14e1f72bf687f9e5)) 
- *(examples)* Add basic language feature examples - ([d2592b1](https://github.com/ElaraLang/elara/commit/d2592b1ba859bbd134154b77e281135def98d1d7)) 
- *(examples)* Add more examples covering tuples, options and generics - ([2cce0bb](https://github.com/ElaraLang/elara/commit/2cce0bb047c340c517a3f4946c4a2d0831809a79)) 
- *(examples)* Add descriptive comments to examples - ([fbce3fa](https://github.com/ElaraLang/elara/commit/fbce3fa22608e3f21595819c0552cf7099b9a3a3)) 
- *(examples)* Improve comments to highlight language features - ([aedff8b](https://github.com/ElaraLang/elara/commit/aedff8bb02b5d95b93d4a5a48426ee2d0b1a2623)) 
- *(examples)* Refine comments to be more technical and concise - ([aff5330](https://github.com/ElaraLang/elara/commit/aff53302ffbc801593516920e2c255427bd8a996)) 
- *(examples)* Tidy up some of the examples documentation - ([2597b06](https://github.com/ElaraLang/elara/commit/2597b06648caa81bba3385a28394f00a31e6daea)) 
- *(examples)* Add simple doc to json parser example - ([9506c01](https://github.com/ElaraLang/elara/commit/9506c016534165923069b3a54cbece54f802a15a)) 
...
- Add a bit of documentation on primitives - ([8856bf7](https://github.com/ElaraLang/elara/commit/8856bf78c863dc6b2d5be1d1978d433a3cdac4ab)) 
...
- *(core)* :art: Tidy up code - ([00d39b4](https://github.com/ElaraLang/elara/commit/00d39b43862b81ca9b3691ca5e5d98949b979b6d)) 
...
- :art: tidy code - ([096492b](https://github.com/ElaraLang/elara/commit/096492b0849c41707ba93a2c83cfe8afc59a00ca)) 
